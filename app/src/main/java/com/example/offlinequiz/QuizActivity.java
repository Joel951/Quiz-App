...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference databaseReference = FirebaseDatabase.getInstance().getReferenceFromUrl("https://offlinequiz-81129-default-rtdb.firebaseio.com/");
        databaseReference.addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot snapshot) {

                //getting all questions form firebase for a specific topic
    ...
    private void startTimer(TextView timertextValue){
        quizTimer = new Timer();
            ...
            public void run() {
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        timertextValue.setText(finalMinutes+":"+finalSeconds);
                    }
                });
            }
        },1000,1000);
